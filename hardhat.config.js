...
const HARDHAT_DEPLOYER = getEnvValSafe("HARDHAT_DEPLOYER");
...
// console.log("HARDHAT_DEPLOYER : ", HARDHAT_DEPLOYER);
...
module.exports = {
  ...
  networks: {
    ...
    mode: {
      url: "https://mainnet.mode.network",
      accounts: [process.env.MODE_DEPLOYER],
    },
    // avalanche: {
    //   chainId: 43114,
    //   url: AVALANCHE_RPC,
